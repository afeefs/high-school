...
public class player {
    ...
    ImageIcon playerFacingLeft = new     ImageIcon("wario2.png");  //Image for player while he is     turning left
    ImageIcon playerFacingRight = new     ImageIcon("wario.png");//Image for player while he is turning right

        public player() {
            player = playerFacingRight.getImage();                                               //Give the player the image
            x = 75;                                                                              //The original x position of the player
            y = 540;                                                                             //The original y position of the player
